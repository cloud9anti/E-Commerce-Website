...
if ($_SESSION["admin"] == "user" || $_SESSION["admin"] == "supplier") {
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="navbar-brand" href="createBPS.php">[Create BPS]</a>
      </li>
	    <h1>   ---------------------------------------</h1>
	  ...
	  <li class="nav-item active">
        <a class="navbar-brand" href="registerSupplier.php"> <?php if ($_SESSION["admin"] == "admin" ) { echo "[Register Supplier Account]"; } ?><span class="sr-only">(current)</span></a>
      </li>
	  <li class="nav-item active">
