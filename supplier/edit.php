...
if (isset ($_POST['name'])  && isset($_POST['groups']) && isset($_POST['community']) && isset($_POST['venue']) && isset($_POST['active']) && isset($_POST['industry']) && isset($_POST['category']) && isset($_POST['subcategory']) ) {
  ...
  mysqli_query($con, "UPDATE people SET name='$name', groups='$groups', community='$community', venue='$venue', active='$active', industry='$industry', category='$category', subcategory='$subcategory' WHERE id='$id'");


 mysqli_query($con, "INSERT INTO products(name, details, sku, price, image, groups, category, subcategory, Vendor_ID) VALUES('$name', '$details', '$sku', '$price', '$image', '$groups', '$category', '$subcategory', '$id')");
